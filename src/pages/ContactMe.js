    ...
    <form className='w-[50vh] md:w-[100vh] mx-auto mt-8'>
        <div className='mb-6'>
            <label htmlfor='name' className='block m-2 text-lg font-medium text-gray-900 dark:text-white'>Name</label>
             <input type='text' name='name' className='bg-gray-50 border border-gray-300 text-gray-900
        ...
        <div className='mb-6'>
            ...
            <label htmlfor='message' className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Your Message</label>    
                <textarea name='message' rows='4' className='block p-2.5 w-full text-sm text-gray-900 bg--gray-50
                rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 
                dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                 dark:focus:border-blue-500' placeholder='Write your thoughts here'> </textarea>
                 
                 <button type='submit' className='text-white mt-8 bg-blue-700 hover:bg-blue-800
